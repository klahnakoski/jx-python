...
setup(
    ...
    install_requires=["mo-collections>=2.31.19025","mo-dots>=2.37.19026","mo-files>=2.31.19025","mo-future>=2.40.19027","mo-json>=2.40.19027","mo-json-config>=2.34.19026","mo-kwargs>=2.32.19026","mo-logs>=2.39.19026","mo-math>=2.40.19027","mo-threads>=2.31.19025","mo-times>=2.40.19027"],
    version=str(u'2.40.19027'),
