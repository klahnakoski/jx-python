...
setup(
    ...
    install_requires=["mo-collections==5.252.22317","mo-dots==9.251.22317","mo-files==5.252.22317","mo-future==6.230.22310","mo-json==6.252.22317","mo-json-config==3.259.22317","mo-kwargs==7.252.22317","mo-logs==7.252.22317","mo-math==7.252.22317","mo-threads==5.252.22317","mo-times==5.252.22317"],
    license='MPL 2.0',
