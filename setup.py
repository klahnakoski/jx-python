...
setup(
    ...
    install_requires=["mo-collections>=3.77.20190","mo-dots>=3.78.20194","mo-files>=3.77.20190","mo-future>=3.71.20168","mo-json>=3.78.20194","mo-json-config>=3.77.20190","mo-kwargs>=3.77.20190","mo-logs>=3.78.20194","mo-math>=3.77.20190","mo-threads>=3.78.20194","mo-times>=3.76.20190"],
    license='MPL 2.0',
