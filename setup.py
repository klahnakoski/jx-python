...
setup(
    ...
    install_requires=["mo-collections==4.3.20340","mo-dots==4.22.21108","mo-files==4.25.21109","mo-future==3.147.20327","mo-json==4.23.21108","mo-json-config==3.77.20190","mo-kwargs==4.22.21108","mo-logs==4.23.21108","mo-math==4.23.21108","mo-threads==4.24.21108","mo-times==4.23.21108"],
    license='MPL 2.0',
