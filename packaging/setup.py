...
setup(
    ...
    install_requires=["mo-collections==5.601.24115","mo-dots==9.601.24115","mo-future==7.584.24095","mo-json==6.601.24115","mo-json-config==4.601.24115","mo-kwargs==7.601.24115","mo-logs==8.601.24115","mo-math==7.601.24115","mo-threads==6.601.24115","mo-times==5.601.24115"],
    license='MPL 2.0',
