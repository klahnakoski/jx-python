...
setup(
    ...
    install_requires=["mo-collections==5.553.24062","mo-dots==9.549.24062","mo-future==7.546.24057","mo-json==6.552.24062","mo-json-config==4.555.24068","mo-kwargs==7.551.24062","mo-logs==8.551.24062","mo-math==7.552.24062","mo-threads==6.552.24062","mo-times==5.552.24062"],
    license='MPL 2.0',
