...
setup(
    ...
    install_requires=["mo-collections==5.373.23120","mo-dots==9.368.23092","mo-files==6.373.23120","mo-future==7.340.23006","mo-json==6.373.23120","mo-json-config==4.373.23120","mo-kwargs==7.368.23092","mo-logs==7.371.23118","mo-math==7.368.23092","mo-threads==5.371.23118","mo-times==5.371.23118"],
    license='MPL 2.0',
